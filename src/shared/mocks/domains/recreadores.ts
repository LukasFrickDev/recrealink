...
const recreadoresDomainList: RecreadorDomainEntity[] = [
  ...
  },
  {
    ...
    bio: "Especialista em programação para famílias, coordenacao de equipes e operação de atividades sazonais.",
    specialties: [
  ...
  },
  {
    ...
    bio: "Monitor voltado para atividades de praia, integracao e dinâmicas em grupo.",
    specialties: ["Atividades ao ar livre", "Integracao", "Dinâmicas em grupo"],
  ...
  },
  {
    ...
    specialties: ["Lideranca de equipe", "Operação em resort", "Programação mista"],
...
export const recreadorFeedbackDomainMock: RecreadorFeedbackDomainEntity[] = [
  {
    ...
    rating: 5,
    message: "Entregou dinâmicas com alta energia e excelente relacao com as famílias.",
