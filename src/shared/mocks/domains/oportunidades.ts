...
export const oportunidadesDomainMock: OportunidadeDomainEntity[] = [
  ...
  },
  {
    ...
    compensationLabel: "R$ 380 / diaria",
    statusLabel: "Ativa",
    urgencyLabel: "normal",
    openings: 3,
...
export const convitesDomainMock: ConviteDomainEntity[] = [
  {
    ...
    proposedValueLabel: "R$ 360 / diaria",
    responseDeadlineLabel: "3 dias",
    notes: "Evento tematico para famílias com foco em atividades de integracao.",
  },
  {
    ...
    proposedValueLabel: "R$ 410 / diaria",
