...
const providerCatalogDomainList: ProviderCatalogDomainEntity[] = [
  ...
  },
  {
    ...
    description: "Profissional autonomo com foco em festas, condominio e pequenas temporadas.",
    specialties: ["Recreação infantil", "Gincanas", "Atividades para famílias"],
    nextSlots: ["Sabado tarde", "Segunda manha"],
  ...
  },
  {
    ...
    neighborhood: "Distrito de Barao Geraldo",
    rating: 4.6,
    reviews: 87,
    verified: false,
    ...
    nextSlots: ["Quinta noite", "Domingo manha"],
  },
];
...
const favoritesDomainList: FavoritoDomainEntity[] = [
  {
    ...
    nextAvailability: "Disponibilidade: sabado e domingo",
  },
  {
    id: "fav-recreador-autonomo",
    provider: { kind: "recreador", id: "rec-rafael-matos" },
    lastContact: "Último contato: ha 2 dias",
...
const historicoEventosDomainList: HistoricoEventoDomainEntity[] = [
  {
    id: "hist-festa-julia",
    provider: { kind: "empresa", id: "emp-recreacao-diversao-total" },
    title: "Festa de aniversario da Julia",
    when: "15 jan 2026",
    duration: "4 horas",
    ...
    amount: "R$ 1.850",
    photos: 42,
    notes: "Equipe pontual, excelente interacao com criancas e cronograma cumprido.",
  },
  {
    id: "hist-colonia-ferias",
    provider: { kind: "hotel", id: "hotel-encanto-family" },
    title: "Colonia de ferias de inverno",
    when: "03 jan 2026",
    duration: "6 horas",
  ...
  },
  {
    ...
    title: "Evento no condominio Primavera",
    when: "18 dez 2025",
    duration: "3 horas",
    audience: "18 criancas",
    rating: 5,
    amount: "R$ 1.200",
    photos: 27,
    notes: "Atendimento muito elogiado pelas famílias e alta taxa de recomendacao.",
    locationOverride: "Campinas - SP",
  },
];
...
export const paisHistoricoHighlightsDomainMock = [
  ...
  },
  {
    ...
    value: "6",
    helper: "Parceiros com duas ou mais contratacoes",
  },
];
...
const avaliacoesPendentesDomainList: AvaliacaoPendenteDomainEntity[] = [
  {
    ...
    deadline: "Prazo ate 20 jan 2026",
  },
  {
    id: "pendente-colonia",
    provider: { kind: "hotel", id: "hotel-encanto-family" },
    event: "Colonia de ferias",
    deadline: "Prazo ate 25 jan 2026",
  },
];
...
const avaliacoesPublicadasDomainList: AvaliacaoPublicadaDomainEntity[] = [
  ...
  },
  {
    ...
    date: "19 dez 2025",
    score: 5,
    comment: "Atividades criativas e interacao excelente com criancas de diferentes idades.",
    likes: 14,
    helpfulCount: 11,
  },
];
...
const agendaEventosDomainList: AgendaEventoDomainEntity[] = [
  {
    ...
    provider: { kind: "empresa", id: "emp-recreacao-diversao-total" },
    title: "Reuniao de proposta final",
    date: "Ter, 19 mar",
    period: "19h as 20h",
  ...
  },
  {
    ...
    budget: "Sem custo",
    status: "Pendente",
    note: "Validar estrutura para recreação e pontos de apoio para criancas.",
  },
  {
