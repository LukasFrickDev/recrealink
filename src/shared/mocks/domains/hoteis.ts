...
const hoteisDomainList: HotelDomainEntity[] = [
  {
    ...
    category: "Resort",
    description: "Resort familiar com programação diária e grande fluxo de crianças.",
    image:
    ...
    rating: 4.9,
    reviews: 412,
    structure: ["Piscina infantil", "Kids club", "Espaço família", "Auditório"],
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 366,
    structure: ["Piscinas", "Teatro", "Área kids", "Espaço gastronômico"],
  ...
  },
  {
    ...
    state: "SP",
    locationLabel: "Águas de São Pedro - SP",
    category: "Hotel",
    description: "Hotel tradicional com projetos para diferentes faixas etárias.",
    image:
    ...
    rating: 4.7,
    reviews: 241,
    structure: ["Sala de jogos", "Espaço infantil", "Campo aberto"],
  ...
  },
  {
    ...
    category: "Resort",
    description: "Ambiente premium para recreação aquática e equipes sazonais.",
    image:
    ...
    rating: 4.7,
    reviews: 198,
    structure: ["Parque aquático", "Kids club", "Sala multimídia"],
  ...
  },
  {
    ...
    category: "Hotel",
    description: "Programação infantil em ambiente rural e lazer familiar.",
  ...
  },
  {
    ...
    state: "SP",
    locationLabel: "Campos do Jordão - SP",
    category: "Pousada",
    description: "Operações menores com calendário frequente de atividades.",
    image: "https://images.unsplash.com/photo-1540541338287-41700207dee6?q=80&w=1600&auto=format&fit=crop",
    rating: 4.5,
    reviews: 122,
    structure: ["Espaço coberto", "Sala de apoio", "Lazer ao ar livre"],
  ...
  },
  {
    ...
    category: "Pousada",
    description: "Unidade litorânea com calendário frequente para finais de semana e feriados.",
    image: "https://images.unsplash.com/photo-1496417263034-38ec4f0b665a?q=80&w=1600&auto=format&fit=crop",
    rating: 4.8,
    reviews: 134,
    structure: ["Sala kids", "Deck externo", "Área de convívio"],
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 176,
    structure: ["Piscina", "Espaço de jogos", "Sala de oficinas"],
  ...
  },
  {
    ...
    locationLabel: "Santos - SP",
    category: "Hotel",
    description: "Hotel urbano com programação de fim de semana para famílias e grupos.",
  ...
  },
  {
    ...
    category: "Resort",
    description: "Resort beira-mar com operação de lazer para crianças, jovens e famílias.",
    image: "https://images.unsplash.com/photo-1445019980597-93fa8acb246c?q=80&w=1600&auto=format&fit=crop",
    rating: 4.8,
    reviews: 290,
    structure: ["Piscinas", "Quadras", "Espaço kids", "Auditório"],
