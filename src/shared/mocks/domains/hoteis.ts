...
const hoteisDomainList: HotelDomainEntity[] = [
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 366,
    structure: ["Piscinas", "Teatro", "Area kids", "Espaco gastronomico"],
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 150,
    structure: ["Area verde", "Brinquedoteca", "Trilhas guiadas"],
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 134,
    structure: ["Sala kids", "Deck externo", "Area de convivio"],
  ...
  },
  {
    ...
    category: "Resort",
    description: "Resort de medio porte com alta demanda em temporadas e feriados prolongados.",
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 109,
    structure: ["Sala de recreação", "Lobby kids", "Area gourmet"],
