...
export const recreadorOportunidadesMock = {
  title: "Oportunidades",
  description:
    "Central de vagas do recreador com oportunidades de hotelaria e eventos, sem misturar gestão de convites.",
  stats: [
  ...
  filters: {
    ...
    dates: [
      ...
      { id: "proximos-15-dias", label: "Próximos 15 dias" },
  ...
  journeyLegend: [
    {
      ...
      helper: "A oportunidade segue visível até evoluir para convite ou encerramento.",
    },
    {
      id: "convite-recebido",
      title: "Convite recebido",
      helper: "A decisão de aceitar ou recusar acontece somente em Convites.",
    },
    {
      id: "confirmada",
      title: "Confirmada",
      helper: "Item convertido em compromisso futuro para integrar a disponibilidade na próxima fase.",
    },
  ...
  items: [
    {
      ...
      originSummary: "Operação de lazer infantil em pacote de feriado.",
      roleLabel: "Recreador líder de turno",
      cityCode: "sp",
      cityLabel: "São Paulo - SP",
      type: "resort",
      dateWindow: "esta-semana",
      periodLabel: "22 Abr a 25 Abr 2026",
      startDateLabel: "Início em 22 Abr",
      compensationLabel: "R$ 540 por diária",
    ...
    },
    {
      ...
      startDateLabel: "Início em 30 Abr",
    ...
    },
    {
      ...
      startDateLabel: "Início em 05 Mai",
    ...
    },
    {
      ...
      originSummary: "Evento social com trilha criativa para famílias.",
      ...
      startDateLabel: "Início em 14 Mai",
    ...
    },
    {
      ...
      startDateLabel: "Início em 20 Abr",
    ...
    },
    {
      ...
      startDateLabel: "Início em 18 Mai",
    ...
    },
    {
      ...
      originSummary: "Operação compacta para grupos infantis reduzidos.",
      roleLabel: "Recreador apoio geral",
      cityCode: "sc",
      cityLabel: "Balneário Camboriú - SC",
      type: "hotel",
      dateWindow: "proximos-15-dias",
      periodLabel: "03 Mai a 04 Mai 2026",
      startDateLabel: "Início em 03 Mai",
      compensationLabel: "R$ 430 por diária",
      applicationStatus: "disponivel",
      inviteStatus: "nenhum",
      lifecycleStatus: "aberta",
    },
