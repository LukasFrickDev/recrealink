...
export const hotelariaConfiguracoesFeatureMock: HotelariaFeatureMock = {
  ...
  description: "Ajuste dados do hotel, permissoes, notificações e segurança do módulo.",
  status: "active",
  statusLabel: "Ativo",
  statusDetail: "Página de configurações unificada com base compartilhada de tabs e conteúdo.",
  stats: [
    { title: "Regras ativas", value: "12", helper: "Politicas publicadas" },
    { title: "Perfis de acesso", value: "4", helper: "Niveis operacionais" },
    { title: "Preferencias", value: "18", helper: "Parametrizacoes ativas" },
    { title: "Ajustes pendentes", value: "5", helper: "Aguardando aprovacao" },
  ],
  checkpoints: [
    "Revisar matriz de acesso por cargo.",
    "Padronizar notificações por prioridade.",
    "Publicar politica consolidada apos aprovacao da gestao.",
  ],
  layout: {
    type: "settings",
    ...
    tabs: [
      ...
      },
      {
        id: "notificacoes",
        title: "Notificações",
        helper: "Alertas e preferencias",
        description: "Regras de envio para alertas da operação e atualizacoes da equipe.",
        editable: true,
        options: [],
      },
      {
        ...
        description: "Perfis com acesso ao módulo hotelaria e escopo de permissao.",
        editable: true,
        options: [],
      },
      {
        ...
        description: "Politicas de autenticação, sessão e auditoria do ambiente.",
        editable: true,
        options: [],
      },
    ],
