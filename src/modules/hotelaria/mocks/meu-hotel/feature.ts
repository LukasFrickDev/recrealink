...
export const hotelariaMeuHotelFeatureMock: HotelariaFeatureMock = {
  ...
  status: "active",
  statusLabel: "Ativo",
  statusDetail: "Painel institucional em modo informativo, com compartilhamento rápido para equipe e gestao.",
  stats: [
    ...
    { title: "Atualizacao mensal", value: "14", helper: "Revisões no último ciclo" },
  ],
  checkpoints: [
  ...
  layout: {
    ...
    heroDescription:
      ...
      "Um dos resorts mais tradicionais do litoral paulista, com foco em experiências familiares e operação de recreação continua durante todo o ano.",
