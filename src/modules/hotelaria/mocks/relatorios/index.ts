...
export const hotelariaRelatoriosFeatureMock: HotelariaFeatureMock = {
  ...
  stats: [
    { title: "Relatorios emitidos", value: "22", helper: "Último mes" },
  ...
  layout: {
    ...
    metrics: [
      ...
      { title: "Feedback medio", value: "4.7", helper: "Escala de 1 a 5" },
      { title: "Tempo medio de escala", value: "2h20", helper: "Do rascunho ao fechamento" },
