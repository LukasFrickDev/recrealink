...
export const hotelariaRelatoriosFeatureMock: HotelariaFeatureMock = {
  ...
  stats: [
    { title: "Relatórios emitidos", value: "22", helper: "Último mês" },
  ...
  checkpoints: [
    ...
    "Separar períodos por semana, mês, trimestre e ano.",
    "Evidenciar impacto principal no topo do relatório.",
  ],
  layout: {
    type: "relatorios",
    ...
    metrics: [
      { title: "Recreadores contratados", value: "31", helper: "Mês corrente" },
      { title: "Escalas criadas", value: "42", helper: "Cobertura semanal" },
      { title: "Programações executadas", value: "26", helper: "Com checklist completo" },
