...
export const hotelariaOrcamentoFeatureMock: HotelariaFeatureMock = {
  ...
  stats: [
    { title: "Gastos no mês", value: "R$ 18.400", helper: "Despesas aprovadas" },
  ...
  layout: {
    type: "orcamento",
    summary: [
      { title: "Gastos no mês", value: "R$ 18.400", helper: "Consolidado" },
    ...
    expenses: [
      ...
      {
        description: "Reforço de equipe fim de semana",
        value: "R$ 2.040",
        date: "03/12/2026",
        category: "Pessoal",
        status: "Pendente",
